...
def main(_):
    ...
    if FLAGS.do_train:
        ...
        # 4.1) prepare train_input_fn, config
        ...
        # 4.2) prepare eval_input_fn
		# Prepare eval example, config
